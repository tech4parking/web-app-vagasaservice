'use client'
import { Role } from '@vagasaservice/utils/types'
import { useFormRegister } from '@vagasaservice/forms/src/register'
import { useMutation } from '@apollo/client'
import { RegisterWithCredentialsDocument } from '@vagasaservice/network/src/gql/generated'
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 text-sm ">
        Already have an vagasaservice account?
        <br />
