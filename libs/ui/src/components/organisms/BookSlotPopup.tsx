'use client'
import { FormTypeBookSlot } from '@vagasaservice/forms/src/bookSlot'
import { loadStripe } from '@stripe/stripe-js'

import {
  CreateBookingInput,
  SearchGaragesQuery,
} from '@vagasaservice/network/src/gql/generated'
...
import { toLocalISOString } from '@vagasaservice/utils/date'
import { useTotalPrice } from '@vagasaservice/utils/hooks/price'
import { CostTitleValue } from '../molecules/CostTitleValue'
import { Button } from '../atoms/Button'
import { useState } from 'react'
import { useSession } from 'next-auth/react'
import { TotalPrice } from '@vagasaservice/utils/types'
