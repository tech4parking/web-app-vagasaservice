...
} from '@/components/forms/searchGarages'
        ...
        <div className="flex flex-col items-start gap-3">
          <Controller
            ...
            render={({
              ...
              return (
                <div>
                  <FilterHeading dirty={isDirty} title="Tipo do veiculo" />
                  <ToggleButtonGroup
                    value={value}
                    onChange={(_, value) => {
                      onChange(value.sort())
            ...
            render={({
              ...
              return (
                <div className="w-full">
                  <FilterHeading dirty={isDirty} title="Preço por Hora" />
                  <RangeSlider
          ...
          <Controller
            ...
            render={({
              ...
              return (
                <div className="w-full">
                  <FilterHeading dirty={isDirty} title="Largunra" />
                  <RangeSlider
          ...
          <Controller
            ...
            render={({
              ...
              return (
                <div className="w-full">
                  <FilterHeading dirty={isDirty} title="Altura" />
                  <RangeSlider
          ...
          <Controller
            ...
            render={({
              ...
              return (
                <div className="w-full">
                  <FilterHeading dirty={isDirty} title="Quantidade" />
                  <RangeSlider
